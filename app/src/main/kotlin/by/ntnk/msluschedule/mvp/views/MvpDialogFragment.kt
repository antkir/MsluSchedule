...
private const val PRESENTER_ID = "PresenterID"
...
abstract class MvpDialogFragment<out P : Presenter<V>, V : View> : DialogFragment() {
    ...
    private fun restoreId(savedInstanceState: Bundle?): Int? {
        return savedInstanceState?.getSerializable(PRESENTER_ID) as Int?
    }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        outState.putSerializable(PRESENTER_ID, presenterId)
